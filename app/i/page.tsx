    ...
    >
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-10 mb-20">
        <motion.a
          ...
          whileTap={{ scale: 0.95 }}
          className="inline-flex items-center justify-center gap-3 text-xs text-[#F8F5EE] hover:text-white transition-all font-body uppercase tracking-[0.3em] border border-[#A88B5C]/40 rounded-full px-8 py-3.5 hover:bg-[#A88B5C]/10 group hover:border-[#A88B5C]"
          style={{
            WebkitBackdropFilter: "blur(4px)",
            backdropFilter: "blur(4px)",
          }}
